        ...
        extends CloudFixAbs
{
       ...
       throws TException
    {
        try {
            ...
            dumpCounts();
            JSONObject stats = outVerify(objectCurrent, outComponents);
            JSONObject outVerifyJson = new JSONObject();
            outVerifyJson.put("objectID", objectID.getValue());
            outVerifyJson.put("versionCnt", objectCurrent);
            outVerifyJson.put("stats", stats);
        ...
        throws TException
    {
        ...
        try {
            ...
            for (String key : keys) {
                ...
                if (key.contains("mrt-erc.txt")) mrtErcCnt++;
            ...
            validateVersion.put("mrtErcCnt", mrtErcCnt);
