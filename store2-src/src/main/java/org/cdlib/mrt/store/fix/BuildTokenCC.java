        ...
        extends CloudFixAbs
{
    ...
    protected void saveDeleteComponent(ChangeComponent component)
        throws TException
    {
        if (component.getOp() != ChangeComponent.Operation.move_data) return;
        ...
        System.out.println("Delete(" + component.getVersionID() + "):" + deleteKey);
    }
        ...
        throws TException
    {
        ...
        System.out.println("Add(" + component.getVersionID() + "):\n"
       ...
       throws TException
    {
        ...
        try {
            ...
            for (String key : keys) {
                ...
                logFix.info("deleteRemove key(" + deleteSize + ")=" + deleteKey);
                if (runS3) {
