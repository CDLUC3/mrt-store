...
"ark:/99999/fk4xk9qk0t"
        ...
        TestCloudArchive test = new TestCloudArchive(9502, build, logger);
        ...
        throws TException
    {
        ...
        try {
            ...
            File objzip = new File(workBase,"test.zip");
