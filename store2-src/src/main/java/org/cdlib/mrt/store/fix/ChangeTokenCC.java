        ...
        extends CloudFixAbs
{
       ...
       throws TException
    {
        try {
            ...
            dumpCounts();
            outVerify(objectCurrent, outComponents);
   ...
   protected void dumpVersion(int versionID, LinkedHashMap<String, FileComponent>  newVersion)
   {
    ...
    public static void outVerify(int inVersions, 
        ...
        throws TException
    {
        ...
        for (LinkedHashMap<String, ChangeComponent> outVersion : outComponents) {
            outVersionNum++;
            validateOutVersion(outVersionNum, outVersion);
        }
        
    }
    
    public static void validateOutVersion(int outVersionNum, LinkedHashMap<String, ChangeComponent> outVersion)
        throws TException
    {
        ...
        try {
            ...
            for (String key : keys) {
                ...
                if (!inFileID.contains(outFileID)) {
            ...
            System.out.println("***validateOutVersion(" + outVersionNum + ") testCnt=" + testCnt);
